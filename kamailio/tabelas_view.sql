...
insert into servidor_voip(ativo,endereco_ip,nome) values (true,'172.16.11.6','ASTERISK-1');
insert into ramal(nome,numero,senha,empresa,servidor_voip) values('Ramal 1000',1000,'123456',1,1);
insert into ramal(nome,numero,senha,empresa,servidor_voip) values('Ramal 1001',1001,'123456',1,1);
